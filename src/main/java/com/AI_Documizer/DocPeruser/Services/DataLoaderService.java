...
public class DataLoaderService {
    ...
    @Value("classpath:/Distributed_Systems.pdf")
    private Resource pdfResource;



    public DataLoaderService(VectorStore vectorStore, JdbcClient jdbcClient) {
    ...
    public void init(){
        ...
        if(count==0){
            System.out.println("Creating Context Vector Store. Loading relevant docs in the PG Vector Store");
            buildContext();
        }
    }
